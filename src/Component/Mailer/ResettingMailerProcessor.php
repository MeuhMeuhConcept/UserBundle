...
class ResettingMailerProcessor extends MailerProcessor
{
    ...
    public function sendResettingEmailMessage(LoginFormAuthenticatorInterface $loginForm)
    {
        $url = $this->router->generate(
            'mmc_user.resetting',
            ['token' => $loginForm->getPasswordRequestToken()],
